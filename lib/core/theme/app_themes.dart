...
class AppThemes {
  final AppTheme lightTheme = AppTheme(
    ...
    pageBackgroundColor: const Color(0xFFF3F6FB),
    borderColor: const Color(0xFFE2E8F0),
    labelColor: const Color(0xFF334155),
    placeholderColor: const Color(0xFF94A3B8),
    mutedTextColor: const Color(0xFF718094),
    secondaryTextColor: const Color(0xFF64748B),
    tealAccentColor: const Color(0xFF0097B2),
    infoBackgroundColor: const Color(0x1A1392EC),
    infoBorderColor: const Color(0x331392EC),
    warningBackgroundColor: const Color(0xFFFFEDD5),
    warningColor: const Color(0xFFEA580C),
    inputTextColor: const Color(0xFF0A213C),
    bodyMutedColor: const Color(0xFF404850),
    cardBorderColor: const Color(0xFFE0E2E8),
    lightIconContainerColor: const Color(0xFFF1F4F9),
    secondaryBorderColor: const Color(0xFFBFC7D1),
    mutedHintColor: const Color(0xFF6B7280),
    starColor: const Color(0xFFFFB877),
    dividerColor: const Color(0xFFE6E8EE),
