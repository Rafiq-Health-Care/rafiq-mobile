...
class LabTestConfirmScreen extends StatefulWidget {
  ...
  const LabTestConfirmScreen({super.key, required this.response});
...
class _LabTestConfirmScreenState extends State<LabTestConfirmScreen> {
  ...
  void initState() {
    ...
    _testFormCubit = LabTestFormCubit(
      widget.response.tests.map((test) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<LabTestCubit, LabTestState>(
