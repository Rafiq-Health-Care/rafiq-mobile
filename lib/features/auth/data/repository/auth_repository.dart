...
class AuthRepository {
  ...
  Future<Either<Failure, UserResponse>> logInRepository(
    ...
    return rowData.fold((failure) => left(failure), (rowData) async {
      final userResponse = UserResponse.fromJson(rowData);
      await SessionManager.setCurrentUserEmail(body.email);
      await SessionManager.setCurrentUserId(userResponse.userId);
  ...
  Future<Either<Failure, List<String>>> getSpecializationsRepository() async {
