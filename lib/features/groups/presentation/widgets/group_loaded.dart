...
import 'package:rafiq/features/groups/presentation/widgets/group_card.dart';
      ...
      children: [
        Padding(
          ...
          child: CustomScreenHeader(
            ...
            total: state.currentGroups.length,
          ),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16),
        ...
        if (state.allGroups.isEmpty)
          Expanded(
            child: EmptyStateWidget(
              ...
              description: 'Get started by creating your first medicine group.',
            ),
          )
